...
It will ask you which docker registry to use, and whether you want to create an
"alias" (if you don't have it already) for the docker4gis command (so that you
can type e.g. `dg init` instead of `npx --yes docker4gis@latest init`).
